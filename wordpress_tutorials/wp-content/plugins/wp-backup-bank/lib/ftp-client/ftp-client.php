...
if(file_exists(BACKUP_BANK_DIR_PATH."lib/ftp-client/ftp-exception.php"))
{
	require_once BACKUP_BANK_DIR_PATH."lib/ftp-client/ftp-exception.php";
}
if(file_exists(BACKUP_BANK_DIR_PATH."lib/ftp-client/ftp-wrapper.php"))
{
	require_once BACKUP_BANK_DIR_PATH."lib/ftp-client/ftp-wrapper.php";
}
