...
*
* @author  Tech Banker
* @package wp-backup-bank/views/system-information
* @version 3.0.1
*/
...
else
{
	...
	else if(system_information_backup_bank == "1")
	{
		?>
									...
									<div class="form-body">
										<div class="note note-danger">
											...
											<ul>
												...
												<li><?php echo $bb_backup_bank_user_guide_disclaimer; ?><a href="<?php echo "http://beta.tech-banker.com/products/wp-backup-bank/user-guide/system-information/";?>" target="_blank" class='custom_links'><?php echo $bb_backup_bank_click_here; ?></a>.</li>
												<?php
										...
										<div class="form-actions">
											<div class="btn-set pull-right">
												<button type="button" class="btn vivid-green  system-report" name="ux_btn_system_information"  id="ux_btn_system_information"><?php echo "Get System Information!";?></button>
											</div>
										</div>
